  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <h3 className="text-2xl font-bold text-gray-900">Espace Sécurisé</h3>
      </div>

      <div className="max-w-md mx-auto">
        <p className="text-gray-600 mb-8">
          Accédez aux documents confidentiels et aux informations détaillées réservés aux investisseurs.
        </p>
